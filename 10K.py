...
if __name__=='__main__':
    ...
    scraper = TenKScraper('Item 1','Item 2')  # scrape text start from Item 1A, and stop by Item 1B
    scraper2 = TenKScraper('Item 7', 'Item 8')
    scraper.scrape('filing.html', './data/txt/test.txt')
    scraper2.scrape('filing.html', './data/txt/test2.txt')