...
@tool
def reformat_code(loc:str,requirement:str) -> str:
...
program_enhancing_agent = create_agent(llm,
                                       tools=[reformat_code],
                                       middleware=[
                                           HumanInTheLoopMiddleware(
                                               interrupt_on={"reformat_code": True},
                                               description_prefix="Verify code quality"
                                           )
                                       ],
                                       system_prompt="You are a code enhancement agent. Your job is to reformat code files as per user requirements to improve code quality.")
...
query = (
    "I wrote a program to get data from SEC 10k filings in current folder with complete connection to SEC api. "
